...
class HeaderAndReading {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HeaderAndReading(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new HeaderAndReading(null);
...
module.exports = HeaderAndReading;
