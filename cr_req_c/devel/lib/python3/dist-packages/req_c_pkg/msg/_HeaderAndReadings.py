...
"""autogenerated by genpy from req_c_pkg/HeaderAndReadings.msg. Do not edit."""
import codecs
import sys
...
class HeaderAndReadings(genpy.Message):
  _md5sum = "b282dd3d5a07588f4f04a69f41539577"
  _type = "req_c_pkg/HeaderAndReadings"
...
float64 y
float64 z"""
  __slots__ = ['header','angles','sensors_data','poses']
  _slot_types = ['std_msgs/Header','float64[]','float64[]','geometry_msgs/Vector3[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,angles,sensors_data,poses
    ...
    """
    if args or kwds:
      super(HeaderAndReadings, self).__init__(*args, **kwds)
